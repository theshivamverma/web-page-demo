...
const btnCloseIcon = document.querySelector("#btnCloseIcon");
...
menuBtn.addEventListener('click', () => {
  ...
  if(isMenuActive) {
    ...
    btnMenuIcon.style.display = "initial";
    btnCloseIcon.style.display = "none";
    isMenuActive = false;
  }else {
    nav.classList.add("active");
    btnMenuIcon.style.display = 'none';
    btnCloseIcon.style.display = 'initial'
    isMenuActive = true;
  }
})